            ...
            <div class="data-scrollbar" data-scroll="1">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="{{ Request::routeIs('professional-summary.create') ? 'active' : '' }}">
                        ...
                        <li class="{{ Request::routeIs('contact-data.create') ? 'active' : '' }}">
                        ...
                        <li class="{{ Request::routeIs('skills.create') ? 'active' : '' }}">
